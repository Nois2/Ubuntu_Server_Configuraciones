#!/bin/bash
sudo bash -c 'cat << EOF > /etc/ltsp/dhcpd6.conf
...
option dhcp6.name-servers 2001:DB7:DEA:A::;
option dhcp6.domain-search "semita.sv";
...
subnet6 2001:DB7:DEA:A::/64 {
        range6 001:DB7:DEA:A::100 2001:DB7:DEA:A::200
#       prefix6 2001:DB7:DEA:A:: 2001:DB7:DEA:B:: /64;
        option dhcp6.name-servers 2001:DB7:DEA:A::2;
        option dhcp6.domain-search "semita.sv"
}
